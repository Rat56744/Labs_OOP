...
void student_group(student *&students, int &col_student,string *&direction, int &col_direction, int numbers[], int &col_numbers, student *&group_students, int &col_group)
{
